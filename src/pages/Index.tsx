          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                {language === "de" 
                  ? "Wir helfen kleinen Unternehmen und Selbstständigen dabei, online erfolgreich zu wachsen – mit bewährten Strategien und messbaren Ergebnissen."
                  : "We help small businesses and entrepreneurs grow successfully online – with proven strategies and measurable results."
                }
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                {language === "de" 
                  ? "Wir verstehen die einzigartigen Herausforderungen von kleinen Unternehmen und bieten maßgeschneiderte Lösungen."
                  : "We understand the unique challenges of small businesses and provide tailored solutions."
                }
              </p>
